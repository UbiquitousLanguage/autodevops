...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Certmanager.V1Beta1.Inputs
{
    ...
    /// </summary>
    public class IssuerSpecAcmeExternalAccountBindingArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<IssuerSpecAcmeExternalAccountBindingKeySecretRefArgs> KeySecretRef { get; set; } = null!;

        public IssuerSpecAcmeExternalAccountBindingArgs()
        {
        }
    }
}
