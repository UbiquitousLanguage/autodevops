...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Certmanager.V1Beta1.Inputs
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01CloudflareArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<ClusterIssuerSpecAcmeSolversDns01CloudflareApiKeySecretRefArgs>? ApiKeySecretRef { get; set; }

        /// <summary>
        /// API token used to authenticate with Cloudflare.
        /// </summary>
        [Input("apiTokenSecretRef")]
        public Input<ClusterIssuerSpecAcmeSolversDns01CloudflareApiTokenSecretRefArgs>? ApiTokenSecretRef { get; set; }
