...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Certmanager.V1Beta1 {
    ...
    public partial class ClusterIssuer : KubernetesResource {
        ...
        /// </summary>
        [Output("spec")]
        public Output<ClusterIssuerSpec> Spec { get; private set; } = null!;

        /// <summary>
        /// Status of the ClusterIssuer. This is set and managed automatically.
        /// </summary>
        [Output("status")]
        public Output<ClusterIssuerStatus> Status { get; private set; } = null!;
        ...
        public ClusterIssuer(string name, ClusterIssuerArgs? args = null, CustomResourceOptions? options = null)
            : base(
                "kubernetes:cert-manager.io/v1beta1:ClusterIssuer",
                name,
                MakeArgs(args),
                MakeResourceOptions(options, "")
            ) { }

        internal ClusterIssuer(
        ...
        ClusterIssuer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:cert-manager.io/v1beta1:ClusterIssuer", name, null, MakeResourceOptions(options, id)) { }

        static ClusterIssuerArgs? MakeArgs(ClusterIssuerArgs? args) {
            args            ??= new ClusterIssuerArgs();
    ...
    public class ClusterIssuerArgs : ResourceArgs {
        ...
        /// </summary>
        [Input("status")]
        public Input<ClusterIssuerStatusArgs>? Status { get; set; }
