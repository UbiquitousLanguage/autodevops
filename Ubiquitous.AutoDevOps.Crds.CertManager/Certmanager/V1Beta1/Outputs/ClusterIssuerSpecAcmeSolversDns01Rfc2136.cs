...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Certmanager.V1Beta1.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterIssuerSpecAcmeSolversDns01Rfc2136
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ClusterIssuerSpecAcmeSolversDns01Rfc2136TsigSecretSecretRef TsigSecretSecretRef;

        [OutputConstructor]
        private ClusterIssuerSpecAcmeSolversDns01Rfc2136(
            string nameserver,
            ...
            ClusterIssuerSpecAcmeSolversDns01Rfc2136TsigSecretSecretRef tsigSecretSecretRef)
        {
