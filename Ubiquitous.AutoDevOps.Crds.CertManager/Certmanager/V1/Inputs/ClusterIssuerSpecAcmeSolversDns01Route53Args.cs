...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Certmanager.V1.Inputs
{
    ...
    /// </summary>
    public class ClusterIssuerSpecAcmeSolversDns01Route53Args : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<ClusterIssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRefArgs>? SecretAccessKeySecretRef { get; set; }

        public ClusterIssuerSpecAcmeSolversDns01Route53Args()
        {
        }
    }
}
