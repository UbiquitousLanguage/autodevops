...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1.Inputs
{
    ...
    public class OrderStatusArgs : Pulumi.ResourceArgs
    {
        [Input("authorizations")]
        private InputList<OrderStatusAuthorizationsArgs>? _authorizations;
        ...
        /// </summary>
        public InputList<OrderStatusAuthorizationsArgs> Authorizations
        {
            get => _authorizations ?? (_authorizations = new InputList<OrderStatusAuthorizationsArgs>());
