...
using Pulumi;
using Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1.Inputs;
using Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1.Outputs;

namespace Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1 {
    /// <summary>
    ...
    public partial class Order : KubernetesResource {
        ...
        private static OrderArgs? MakeArgs(OrderArgs? args) {
            args            ??= new OrderArgs();
