...
namespace Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1Beta1.Inputs
{
    ...
    /// </summary>
    public class OrderStatusAuthorizationsArgs : Pulumi.ResourceArgs
    {
        [Input("challenges")]
        private InputList<OrderStatusAuthorizationsChallengesArgs>? _challenges;
        ...
        /// </summary>
        public InputList<OrderStatusAuthorizationsChallengesArgs> Challenges
        {
            get => _challenges ?? (_challenges = new InputList<OrderStatusAuthorizationsChallengesArgs>());
