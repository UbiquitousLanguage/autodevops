...
using Pulumi;
using Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1Beta1.Inputs;
using Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1Beta1.Outputs;

namespace Ubiquitous.AutoDevOps.Crds.CertManager.Acme.V1Beta1 {
    /// <summary>
    ...
    public partial class Order : KubernetesResource {
        ...
        [Output("spec")] public Output<OrderSpec> Spec { get; private set; } = null!;

        [Output("status")] public Output<OrderStatus> Status { get; private set; } = null!;
        ...
        public Order(string name, OrderArgs? args = null, CustomResourceOptions? options = null)
            : base(
                "kubernetes:acme.cert-manager.io/v1beta1:Order",
                name,
                MakeArgs(args),
        ...
        Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:acme.cert-manager.io/v1beta1:Order", name, null, MakeResourceOptions(options, id)) { }

        static OrderArgs? MakeArgs(OrderArgs? args) {
            args            ??= new OrderArgs();
            args.ApiVersion =   "acme.cert-manager.io/v1beta1";
            args.Kind       =   "Order";
            return args;
        }
    ...
    public class OrderArgs : ResourceArgs {
        ...
        [Input("spec")] public Input<OrderSpecArgs>? Spec { get; set; }

        [Input("status")] public Input<OrderStatusArgs>? Status { get; set; }
