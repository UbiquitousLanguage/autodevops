...
namespace Ubiquitous.AutoDevOps.Crds.Prometheus.Monitoring.V1 {
    ...
    public partial class ServiceMonitor : KubernetesResource {
        ...
        /// </summary>
        [Output("spec")]
        public Output<ServiceMonitorSpec> Spec { get; private set; } = null!;
        ...
        public ServiceMonitor(string name, ServiceMonitorArgs? args = null, CustomResourceOptions? options = null)
            : base(
        ...
        ServiceMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base(
                "kubernetes:monitoring.coreos.com/v1:ServiceMonitor",
                name,
                null,
        ...
        static ServiceMonitorArgs? MakeArgs(ServiceMonitorArgs? args) {
            args            ??= new ServiceMonitorArgs();
    ...
    public class ServiceMonitorArgs : ResourceArgs {
        ...
        /// </summary>
        [Input("spec")]
        public Input<ServiceMonitorSpecArgs>? Spec { get; set; }
